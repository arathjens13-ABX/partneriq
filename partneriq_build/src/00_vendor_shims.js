...
// LZ-string 1.4.4 — MIT License — https://github.com/pieroxy/lz-string
var LZString=function(){function o(o,r){if(!t[o]){t[o]={};for(var n=0;n<o.length;n++)t[o][o.charAt(n)]=n}return t[o][r]}var r=String.fromCharCode,n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$",t={},i={compressToBase64:function(o){if(null==o)return"";var r=i._compress(o,6,function(o){return n.charAt(o)});switch(r.length%4){default:case 0:return r;case 1:return r+"===";case 2:return r+"==";case 3:return r+"="}},decompressFromBase64:function(r){return null==r?"":""==r?null:i._decompress(r.length,32,function(n){return o(n,r)})},compressToUTF16:function(o){return null==o?"":i._compress(o,15,function(o){return r(o+32)})+" "},decompressFromUTF16:function(o){return null==o?"":""==o?null:i._decompress(o.length,16384,function(r){return o.charCodeAt(r)-32})},compressToUint8Array:function(o){for(var r=i.compress(o),n=new Uint8Array(2*r.length),e=0,t=r.length;e<t;e++){var s=r.charCodeAt(e);n[2*e]=s>>>8,n[2*e+1]=s%256}return n},decompressFromUint8Array:function(o){if(null==o)return i.decompress(o);for(var n=new Array(o.length/2),e=0,t=n.length;e<t;e++)n[e]=256*o[2*e]+o[2*e+1];var s=[];return n.forEach(function(o){s.push(r(o))}),i.decompress(s.join(""))},compressToEncodedURIComponent:function(o){return null==o?"":i._compress(o,6,function(o){return e.charAt(o)})},decompressFromEncodedURIComponent:function(r){return null==r?"":""==r?null:(r=r.replace(/ /g,"+"),i._decompress(r.length,32,function(n){return o(e,r)}))},compress:function(o){return i._compress(o,16,function(o){return r(o)})},decompress:function(o){return null==o?"":""==o?null:i._decompress(o.length,32768,function(r){return o.charCodeAt(r)})},_compress:function(o,r,n){if(null==o)return"";var e,t,i,s={},p={},u="",a="",l="",f=2,c=3,h=2,d=[],m=0,v=0;for(i=0;i<o.length;i+=1){u=o.charAt(i);Object.prototype.hasOwnProperty.call(s,u)||(s[u]={},p[u]=f++,l=u,a=u);a+=u;if(Object.prototype.hasOwnProperty.call(s,a))l=a;else{if(Object.prototype.hasOwnProperty.call(s,l)){if(s[l].charCodeAt(0)<c){for(e=0;e<h;e++)m<<=1,v==r-1?(v=0,d.push(n(m)),m=0):v++;for(t=s[l].charCodeAt(0),e=8;e>0;)m=m<<1|1&t,v==r-1?(v=0,d.push(n(m)),m=0):v++,t>>=1,e--}else{for(t=p[l],e=0;e<h;e++)m=m<<1|1&t,v==r-1?(v=0,d.push(n(m)),m=0):v++,t>>=1}if(0==--c&&(c=Math.pow(2,h),h++),delete p[l]}else for(t=p[l],e=0;e<h;e++)m=m<<1|1&t,v==r-1?(v=0,d.push(n(m)),m=0):v++,t>>=1;c--,p[a]=f++,l=String(u),a=u}}if(""!==l){if(Object.prototype.hasOwnProperty.call(s,l)){if(s[l].charCodeAt(0)<c){for(e=0;e<h;e++)m<<=1,v==r-1?(v=0,d.push(n(m)),m=0):v++;for(t=s[l].charCodeAt(0),e=8;e>0;)m=m<<1|1&t,v==r-1?(v=0,d.push(n(m)),m=0):v++,t>>=1,e--}else{for(t=p[l],e=0;e<h;e++)m=m<<1|1&t,v==r-1?(v=0,d.push(n(m)),m=0):v++,t>>=1}if(0==--c&&(c=Math.pow(2,h),h++),delete p[l]}else for(t=p[l],e=0;e<h;e++)m=m<<1|1&t,v==r-1?(v=0,d.push(n(m)),m=0):v++,t>>=1}for(e=0;e<h;e++)m<<=1,v==r-1?(v=0,d.push(n(m)),m=0):v++;for(;;){if(m<<=1,v==r-1){d.push(n(m));break}v++}return d.join("")},_decompress:function(o,e,t){var i,s,p,u,a,l,f,c=[],h=4,d=4,m=3,v="",w=[],A={val:t(0),position:e,index:1};for(i=0;i<3;i+=1)c[i]=i;for(p=0,a=Math.pow(2,2),l=1;l!=a;)u=A.val&A.position,A.position>>=1,0==A.position&&(A.position=e,A.val=t(A.index++)),p|=(u>0?1:0)*l,l<<=1;switch(p){case 0:for(p=0,a=Math.pow(2,8),l=1;l!=a;)u=A.val&A.position,A.position>>=1,0==A.position&&(A.position=e,A.val=t(A.index++)),p|=(u>0?1:0)*l,l<<=1;f=r(p);break;case 1:for(p=0,a=Math.pow(2,16),l=1;l!=a;)u=A.val&A.position,A.position>>=1,0==A.position&&(A.position=e,A.val=t(A.index++)),p|=(u>0?1:0)*l,l<<=1;f=r(p);break;case 2:return""}for(c[3]=f,s=f,w.push(f);;){if(A.index>o)return"";for(p=0,a=Math.pow(2,m),l=1;l!=a;)u=A.val&A.position,A.position>>=1,0==A.position&&(A.position=e,A.val=t(A.index++)),p|=(u>0?1:0)*l,l<<=1;switch(f=p){case 0:for(p=0,a=Math.pow(2,8),l=1;l!=a;)u=A.val&A.position,A.position>>=1,0==A.position&&(A.position=e,A.val=t(A.index++)),p|=(u>0?1:0)*l,l<<=1;c[d++]=r(p),f=d-1,h--;break;case 1:for(p=0,a=Math.pow(2,16),l=1;l!=a;)u=A.val&A.position,A.position>>=1,0==A.position&&(A.position=e,A.val=t(A.index++)),p|=(u>0?1:0)*l,l<<=1;c[d++]=r(p),f=d-1,h--;break;case 2:return w.join("")}if(0==h&&(h=Math.pow(2,m),m++),c[f])v=c[f];else{if(f!==d)return null;v=s+s.charAt(0)}w.push(v),c[d++]=s+v.charAt(0),h--,s=v,0==h&&(h=Math.pow(2,m),m++)}}};return i}();
